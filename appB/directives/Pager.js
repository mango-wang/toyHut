...
define(['directives/directives'], function (directives) {
    'use strict';
    directives.directive('tmPagination', [function () {
        return {
            restrict: 'EA',
            ...
            link: function (scope, element, attrs) {
                ...
                function getPagination() {
                    ...
                    //}
                    scope.conf.itemsPerPage = parseInt(scope.conf.itemsPerPage) ? parseInt(scope.conf.itemsPerPage) : 12;
                    // numberOfPages
                    ...
                    if (scope.conf.currentPage > scope.conf.numberOfPages && scope.conf.numberOfPages > 0) {
                ...
                scope.$watch(function () {
                    ...
                    var newValue = scope.conf.currentPage + ' ' + scope.$parent.paginationConf.totalItems + ' ';
